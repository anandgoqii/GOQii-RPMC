      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12 md:gap-24">
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li><Link to="/#kit" className="text-[#64748B] text-sm hover:text-[#0F172A] transition-colors">RPM Kit</Link></li>
            <li><Link to="/#compliance" className="text-[#64748B] text-sm hover:text-[#0F172A] transition-colors">Integrations</Link></li>
          </ul>
        </div>
